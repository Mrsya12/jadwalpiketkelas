...
<?php
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
	  ...
	  <li class="nav-item">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="home_admin.php">siswa</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="kehadiran_admin.php">kehadiran</a>
      </ul>
      </ul>
...
<!-- Button -->
    ...
    <?php if(isset($_GET['cari'])): ?>
      <a href="kehadiran_admin.php" class="btn btn-danger ml-2">X</a>
    <?php endif; ?>
  </form>
    </div>
  </div>
  ...
  <script src="assets/js/main.js"></script>
	...
	<a href="tambah2.php" class="btn btn-primary btn-sm">+ TAMBAH SISWA</a>
	</div>
	<br/>
  <a href="print.php" class="btn btn-primary" target="_blank" >PRINT</a>
	...
	<table class="table table-bordered">
		...
		<th style = "background-color:#9BBEC8; color: #fff">No</th>
			...
			<th style = "background-color:#9BBEC8; color: #fff">opsi</th>
		</tr>
		<?php 
		include 'koneksi.php';
		// Proses pencarian
    ...
    ?>
			<tr>
				...
				<td>
				<a href="edit2.php?nisn=<?php echo $d['nisn']; ?>" type="button" class="btn btn-warning"onclick="return confirm('apakah anda yakin ingin ubah data ini ?')">UBAH</a>
				<a href="hapus2.php?hapus=<?php echo $d['nisn'] ?>" type="button" class="btn btn-danger" onclick="return confirm('apakah anda yakin ingin menghapus data ini ?')">HAPUS</a>
				</td>
			</tr>
			<?php 
		}
