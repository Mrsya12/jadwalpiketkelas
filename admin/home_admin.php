...
<!-- Button -->
  ...
  <script src="assets/js/main.js"></script>
	...
	<a href="tambah.php" class="btn btn-primary btn-sm">+ TAMBAH SISWA</a>
	</div>
	<br/>
	<br/>
    ...
    <?php 
        ...
        ?>
			<tr>
				...
				<td>
					<a href="edit.php?nisn=<?php echo $d['nisn'];?>" type="button" class="btn btn-warning"onclick="return confirm('apakah anda yakin ingin mengubah data ini ?')">UBAH</a>
					<a href="hapus.php?hapus=<?php echo $d['nisn'] ?>" type="button" class="btn btn-danger" onclick="return confirm('apakah anda yakin ingin menghapus data ini ?')">HAPUS</a>
				</td>
			</tr>
			<?php 
		}
